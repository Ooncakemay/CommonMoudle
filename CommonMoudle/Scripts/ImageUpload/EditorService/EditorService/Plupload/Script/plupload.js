            ...
            this,
            {
                ...
                init: function () {
                    ...
                    if (typeof (r.preinit) == "function") {
                        ...
                        g.each(r.preinit, function (D, C) { A.bind(C, D) })
                    }
                                ...
                                g.each(G,
                                    ...
                                    if (r.unique_names) {
                                        ...
                                        A.bind("UploadProgress",
                                            function (C, D) {
                                                D.percent = D.size > 0 ? Math.ceil(D.loaded / D.size * 100) : 100; n()
                                            });
                                            A.bind("StateChanged",
                                                function (C) {
                                                ...
                                                A.bind("Error",
                                                    function (C, D) {
                                                        if (D.file) {
                                                            D.file.status = g.FAILED; n();
                                                            if (C.state == g.STARTED) {
                                                                c(function () { s.call(A) }, 1)
                                                            } 
                                                        } 
                                                    });
                                                    A.bind("FileUploaded",
                                                        ...
                                                        function v() {
                                                            ...
                                                            if (typeof (r.init) == "function") {
                                                                ...
                                                                g.each(r.init, function (D, C) { A.bind(C, D) })
                                                            }
                                                        },
                                                        refresh: function () {
                                                        ...
                                                        getFile: function (w) {
                                                            ...
                                                            for (v = t.length - 1; v >= 0; v--) {
                                                                if (t[v].id === w) { return t[v] } 
                                                            } 
                                                        },
                                                        removeFile: function (w) {
                                                            var v;
                                                            for (v = t.length - 1; v >= 0; v--) {
                                                                if (t[v].id === w.id) { return this.splice(v, 1)[0] } 
                                                            } 
                                                        },
                                                        splice: function (x, v) {
                                                            var w;
                                                            ...
                                                            this.trigger("QueueChanged"); return w
                                                        },
                                                        trigger: function (w) {
                                                            ...
                                                            if (y) {
                                                                ...
                                                                for (x = 0; x < y.length; x++) {
                                                                    if (y[x].func.apply(y[x].scope, v) === false) { return false } 
                                                                } 
                                                            } return true
                                                        },
                                                        ...
                                                        bind: function (v, x, w) {
                                                            ...
                                                            v = v.toLowerCase();
                                                            y = o[v] || [];
                                                            y.push({ func: x, scope: w || this }); o[v] = y
                                                        },
                                                        unbind: function (v) {
                                                            v = v.toLowerCase();
                                                ...
                                                g.File = function (q, o, p) {
                                                    ...
                                                    n.name = o; 
                                                    n.size = p;
                                                    n.loaded = 0; n.percent = 0; n.status = 0
                                                };
                                                g.Runtime = function () {
